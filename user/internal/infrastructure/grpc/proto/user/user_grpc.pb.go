...
func (c *userServiceClient) ValidateUser(ctx context.Context, in *ValidateUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) ValidateUser(context.Context, *ValidateUserRequest) (*UserResponse, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "infrastructure/grpc/proto/user/user.proto",
}
