...
import (
	...
	"github.com/bhtoan2204/comment/internal/infrastructure/db/mysql/persistent_object"
...
func migrateTables() {
	models := []interface{}{
		&persistent_object.Comment{},
		&persistent_object.EditHistory{},
		&persistent_object.Reaction{},
	}
